...
INSERT INTO
  course_content (content, week, content_type)
VALUES
  ('00_intro', 46, 'lecture'),
...
INSERT INTO
  course_content (content, week, content_type)
VALUES
  ('02_setup_duckdb', 46, 'lecture') --i) You see that 02_setup_duckdb comes in the end of your table, even though the week is 46. Now make a query where you sort the weeks in ascending order.
SELECT
  *
FROM
  course_content
